...
import { Layout, UserCog, Settings as SettingsIcon, LogOut, Circle, ArrowLeft, Plus, Copy, ExternalLink, Shield, Wrench, Trash2 } from 'lucide-react';
  ...
  const links = [
    ...
    },
    {
      ...
      subLinks: [
        ...
        { label: "Tracking", href: "/tools/tracking", icon: <Circle className="h-4 w-4" /> },
      ],
    },
    {
      label: "Profile",
