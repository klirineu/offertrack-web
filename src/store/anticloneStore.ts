...
type NewAnticloneSite = Omit<AnticloneSite, 'id' | 'created_at' | 'updated_at' | 'user_id'>

export type AnticloneActionType = 'redirect' | 'replace_links' | 'replace_images';
...
export const useAnticloneStore = create<AnticloneStore>((set, get) => ({
  sites: [],
  isLoading: false,
  error: null,
